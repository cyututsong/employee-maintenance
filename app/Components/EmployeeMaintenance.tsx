...
import { deleteEmployee, saveFields, loadEmployees } from "../utils/EmployeeMUtils";
  ...
  return (
     ...
     <div className="container mx-auto p-4 flex flex-col gap-4 w-1/2">
        ...
        <div className="flex flex-row gap-6">
            <input className ="px-3 py-2 w-1/2 border-1 rounded-sm" type="text" name="fname" id="fname" placeholder="Enter your First Name" value={formData.fname} onChange={handleChange}  disabled={isDisabled} />
        ...
        <div className="grid grid-cols-4 gap-4">   
            ...
            <button className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600" onClick={() => deleteEmployee()}>Delete</button>
